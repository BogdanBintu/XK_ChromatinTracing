...
def f(ifov,iQs=None):
    if True:
        chr_ = sca.chromatin_analyzer(data_folders = [r'\\MERFISH6.ucsd.edu\merfish6v2\DNA_FISH\20230212_R120PVTS32RDNABDNF'],
                              save_folder=r'\\MERFISH6.ucsd.edu\merfish6v2\DNA_FISH\20230212_R120PVTS32RDNABDNF_Analysis',
